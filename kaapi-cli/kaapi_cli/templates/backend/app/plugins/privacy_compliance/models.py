...
class UserConsent(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("user.id"), nullable=True)  # Null for non-logged-in user
...
class DataRequest(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("user.id"), nullable=True)  # Null for email requests
...
class PrivacyPolicy(Base):
    ...
    creator = relationship("User", backref="privacy_policies")
...
class AnonymizationLog(Base):
    ...
    performer = relationship("User", backref="anonymization_logs")
