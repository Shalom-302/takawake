    ...
    <footer className="bg-gray-100 py-20 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <motion.div variants={fadeIn('up')} className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-primary to-indigo-700 bg-clip-text text-transparent">Kaapi</span>
            </div>
            <p className="text-gray-600 mb-6 md:max-w-xs">
              Empowering developers to build better APIs faster with a modern, intuitive framework.
            </p>
            <div className="flex gap-4">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-white">
          ...
          <motion.div variants={fadeIn('up', 0.1)}>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Admin Dashboard</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Plugins</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Pricing</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Roadmap</a></li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={fadeIn('up', 0.2)}>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">GitHub</a></li>
            </ul>
          </motion.div>
        </motion.div>
        ...
        <motion.div 
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="pt-10 mt-10 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center"
        >
          <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} Kaapi. All rights reserved.</p>
